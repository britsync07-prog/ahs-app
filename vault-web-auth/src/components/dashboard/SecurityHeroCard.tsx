...
export const SecurityHeroCard: React.FC<SecurityHeroCardProps> = ({ status }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-[40px] p-8 bg-gradient-to-br from-surface to-black border border-white/5 shadow-2xl">
      ...
      <div className="relative flex flex-col items-center py-6">
        <div className="relative mb-6">
          ...
          <div className={`relative w-24 h-24 rounded-full flex items-center justify-center border ${
            ...
            isProtected ? 'border-emerald-green/30 bg-emerald-green/10' : 'border-white/10 bg-white/5'
          }`}>
            {isUnlocked ? (
        ...
        <h2 className="text-sm font-bold text-white/40 uppercase tracking-[0.2em] mb-1">
          Vault Status
        </h2>
        <p className={`text-3xl font-bold tracking-tight ${
          isUnlocked ? 'text-neon-cyan' : isProtected ? 'text-emerald-green' : 'text-white/40'
        }`}>
